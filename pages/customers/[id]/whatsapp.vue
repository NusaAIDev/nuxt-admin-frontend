      ...
      <div class="col-lg-8">
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label text-secondary fw-medium">WhatsApp Number</label>
                <div class="input-group">
                  <span class="input-group-text"><i class="bi bi-whatsapp text-success"></i></span>
                  <input type="text" class="form-control" :value="whatsappData.whatsappNumber" readonly>
                </div>
              </div>
              <div class="col-md-6">
                <label class="form-label text-secondary fw-medium">Phone Number ID</label>
                <input type="text" class="form-control" :value="whatsappData.phoneNumberId" readonly>
              </div>
              <div class="col-md-6">
                <label class="form-label text-secondary fw-medium">Business Account ID</label>
                <input type="text" class="form-control" :value="whatsappData.businessAccountId" readonly>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-12">
                <label class="form-label text-secondary fw-medium">Access Token</label>
                <div class="input-group">
                  <input :type="showToken ? 'text' : 'password'" class="form-control font-monospace" :value="whatsappData.accessToken" readonly>
                  <button class="btn btn-outline-secondary" @click="showToken = !showToken">
                    <i :class="showToken ? 'bi bi-eye-slash' : 'bi bi-eye'"></i>
                  </button>
                </div>
              </div>
              <div class="col-12">
                <label class="form-label text-secondary fw-medium">Webhook Verify Token</label>
                <input type="text" class="form-control font-monospace" :value="whatsappData.webhookVerifyToken" readonly>
              </div>
              <div class="col-12">
                <label class="form-label text-secondary fw-medium">Last Webhook Event</label>
                <input type="text" class="form-control" :value="whatsappData.lastWebhookEventTime || 'No events yet'" readonly>
              </div>
            </div>
          </div>
        </div>
