    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        ...
        <p class="text-secondary small mb-0">
          Manage customer details and workspace settings
        </p>
      </div>
    </div>
      ...
      <div class="col-md-8">
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label text-secondary fw-medium small"
                  >Full Name</label
                >
                <input
                  type="text"
              ...
              <div class="col-md-4">
                ...
                <input
                  ...
                  type="text"
                  class="form-control"
                  :value="customer.industry || 'Not set'"
                  readonly
                />
              </div>
              <div class="col-md-4">
              ...
              <div class="col-12">
                ...
                <textarea
                  ...
                  v-model="form.notes"
                ></textarea>
                <div v-else class="p-3 bg-light rounded small">
        ...
        <div class="card shadow-sm border-0 bg-light-subtle">
          <div class="card-body">
            ...
            <div class="small text-muted">
              These settings define the foundation of the customer's workspace.
              Industry and region info help in tuning high-level AI responses.
            </div>
          </div>
        </div>
      </div>
