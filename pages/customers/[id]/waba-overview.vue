    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        ...
        <p class="text-secondary small mb-0">
          Official WhatsApp Business Account integration and AI behavior
          settings
        </p>
      </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-8">
        <div class="card border-0 shadow-sm p-4 mb-4">
          <h6 class="fw-bold mb-4 text-uppercase small text-muted">
            Business Registration
          </h6>
          <div class="row g-4">
            <div class="col-md-6">
              <label class="form-label text-secondary fw-semibold extra-small"
                >REG. BUSINESS NAME</label
              >
              <input
                type="text"
        ...
        <div class="card border-0 shadow-sm p-4">
          ...
          <div class="col-12">
            <textarea
              ...
              :readonly="!isEditing"
              placeholder="Define persona, rules, and knowledge..."
            ></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
          ...
          <div class="d-flex align-items-center mb-4">
            ...
            <div>
              ...
              <div class="h3 fw-bold mb-0 text-dark">
                {{ customer.messagesThisMonth.toLocaleString() }}
              </div>
            </div>
          </div>
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <span class="fw-bold small text-dark">{{
                customer.aiModeDefault ? "Automated" : "Manual"
              }}</span>
            </div>
        ...
        <div class="card border-0 shadow-sm bg-danger bg-opacity-10 p-4">
          ...
          <p class="text-danger small opacity-75 mb-3">
            Suspending the workspace will immediately stop all AI responses and
            webhook processing.
          </p>
