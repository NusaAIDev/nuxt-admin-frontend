      ...
      <div class="col-md-7">
        <div class="card border-0 shadow-sm mb-4">
          ...
          <div class="card-body bg-light rounded-bottom p-4">
            ...
            <div class="whatsapp-bubble shadow-sm p-3 bg-white mx-auto" style="max-width: 400px; border-radius: 0 15px 15px 15px;">
              <div v-for="component in template.components" :key="component.type" class="mb-2">
                <!-- Header -->
                <div v-if="component.type === 'HEADER'" class="fw-bold mb-1 text-dark border-bottom pb-1 mb-2">
                   {{ component.text }}
                </div>
                <!-- Body -->
                <div v-if="component.type === 'BODY'" class="text-dark whitespace-pre-wrap">
                  {{ component.text }}
                </div>
                <!-- Footer -->
                <div v-if="component.type === 'FOOTER'" class="text-muted small mt-2">
                  {{ component.text }}
                </div>
                <!-- Buttons -->
                <div v-if="component.type === 'BUTTONS'" class="mt-3 border-top pt-2">
                  <div v-for="btn in component.buttons" :key="btn.text" class="d-grid mb-1">
                    <button class="btn btn-sm btn-outline-primary border-0 bg-light-subtle d-flex align-items-center justify-content-center">
                      <i v-if="btn.type === 'URL'" class="bi bi-box-arrow-up-right me-2"></i>
        ...
        <div class="card border-0 shadow-sm">
          ...
          <div class="card-body">
            <div v-if="parameters.length > 0">
              <div v-for="param in parameters" :key="param" class="d-flex align-items-center mb-2">
                <span class="badge bg-primary me-3">{{ param }}</span>
                <span class="text-secondary small">Needs value mapping during send</span>
              </div>
            </div>
        ...
        <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
          ...
          <div class="card-body">
            <form @submit.prevent="handleSendTest">
              <div class="mb-3">
                <label class="form-label small fw-bold">Recipient Phone Number</label>
                <input 
                  ...
                  required
                >
                <div class="form-text extra-small">Include country code (e.g., +62)</div>
              </div>
              ...
              <div v-if="sentSuccess" class="alert alert-success mt-3 py-2 small d-flex align-items-center">
